 ...
 */
DEGORASASI_EXPORT types::OperationResult enumerateCameras(types::CameraDescriptorList& list);
 ...
 */
DEGORASASI_EXPORT types::OperationResult enumerateByModel(const std::string& model,
 ...
 */
DEGORASASI_EXPORT types::OperationResult findCameraById(types::CameraId id, types::CameraDescriptor& out_desc);
 ...
 */
DEGORASASI_EXPORT bool nameMatchesModel(const std::string& name, const std::string& model);
 ...
 */
DEGORASASI_EXPORT std::string getSdkVersion();
