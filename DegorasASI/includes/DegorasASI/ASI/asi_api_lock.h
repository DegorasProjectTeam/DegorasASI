 ...
 */
DEGORASASI_EXPORT std::mutex& discoveryMtx();
 ...
 */
DEGORASASI_EXPORT std::mutex& cameraMtx(types::CameraId id);
 ...
 */
DEGORASASI_EXPORT std::mutex& acquisitionMtx(types::CameraId id);
