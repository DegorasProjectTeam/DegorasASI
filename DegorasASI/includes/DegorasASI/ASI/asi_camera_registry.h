 ...
 */
DEGORASASI_EXPORT bool tryClaimCamera(types::CameraId id);
 ...
 */
DEGORASASI_EXPORT void releaseCamera(types::CameraId id) noexcept;
 ...
 */
DEGORASASI_EXPORT bool isCameraClaimed(types::CameraId id);
