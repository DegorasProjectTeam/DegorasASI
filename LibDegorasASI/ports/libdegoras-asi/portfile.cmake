# Overlay port for LibDegorasASI.
#
...
vcpkg_from_github(
    ...
    REPO DegorasProjectTeam/LibDegorasASI
    REF "v${VERSION}"
...
vcpkg_cmake_configure(
    SOURCE_PATH "${SOURCE_PATH}/LibDegorasASI"
    OPTIONS
        -DLIBDEGORASASI_INSTALL=ON
        -DLIBDEGORASASI_BUILD_TESTING=OFF
        -DLIBDEGORASASI_BUILD_EXAMPLES=OFF
        -DLIBDEGORASASI_INSTALL_ASI_RUNTIME=ON
)
...
configure_file(
    "${SOURCE_PATH}/LibDegorasASI/cmake/usage"
