 ...
 */
LIBDEGORASASI_EXPORT std::string toString(OperationResult r);
...
LIBDEGORASASI_EXPORT std::string toString(ImageFormat format);
...
LIBDEGORASASI_EXPORT std::string toString(UsbLinkSpeed speed);
...
LIBDEGORASASI_EXPORT std::string toString(BayerPattern pattern);
...
LIBDEGORASASI_EXPORT std::string toString(ControlType type);
...
LIBDEGORASASI_EXPORT std::string toString(ExposureState state);
...
LIBDEGORASASI_EXPORT std::string toString(AcquisitionMode mode);
 ...
 */
struct LIBDEGORASASI_EXPORT RoiFormat
{
    RoiFormat();
 ...
 */
struct LIBDEGORASASI_EXPORT RoiPosition
{
    RoiPosition();
 ...
 */
struct LIBDEGORASASI_EXPORT ControlCaps
{
    ControlCaps();
...
struct LIBDEGORASASI_EXPORT ControlValue
{
    ControlValue();
 ...
 */
struct LIBDEGORASASI_EXPORT CameraDescriptor
{
    CameraDescriptor();
 ...
 */
struct LIBDEGORASASI_EXPORT Frame
{
    Frame();
 ...
 */
struct LIBDEGORASASI_EXPORT CameraStatus
{
    CameraStatus();
 ...
 */
struct LIBDEGORASASI_EXPORT DeviceError
{
 ...
 */
LIBDEGORASASI_EXPORT std::size_t bytesPerPixel(ImageFormat format);
 ...
 */
LIBDEGORASASI_EXPORT std::size_t frameBufferSize(const RoiFormat& roi);
 ...
 */
LIBDEGORASASI_EXPORT bool isRoiAligned(const RoiFormat& roi);
...
LIBDEGORASASI_EXPORT int toType(CameraId id);

LIBDEGORASASI_EXPORT int toType(ImageFormat format);

LIBDEGORASASI_EXPORT int toType(ControlType type);

LIBDEGORASASI_EXPORT int toType(FlipMode mode);

/// @brief Map a raw ASI_IMG_TYPE ordinal to an ImageFormat. @return False if @p raw is not a format this library knows.
LIBDEGORASASI_EXPORT bool imageFormatFromType(int raw, ImageFormat& out_format);

/// @brief Map a raw ASI_BAYER_PATTERN ordinal to a BayerPattern. @return False if @p raw is out of range.
LIBDEGORASASI_EXPORT bool bayerPatternFromType(int raw, BayerPattern& out_pattern);

/// @brief Map a raw ASI_CONTROL_TYPE ordinal to a ControlType. @return False if @p raw is not a known control.
LIBDEGORASASI_EXPORT bool controlTypeFromType(int raw, ControlType& out_type);

/// @brief Map a raw ASI_EXPOSURE_STATUS ordinal to an ExposureState. @return False if @p raw is out of range.
LIBDEGORASASI_EXPORT bool exposureStateFromType(int raw, ExposureState& out_state);
